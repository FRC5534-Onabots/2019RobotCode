 ...
 *
 */
public class Elev1Up extends Command {
    ...
    protected void initialize() {
        Robot.elevator1.initTopCounter();
    }

    // Called repeatedly when this Command is scheduled to run
    @Override
    protected void execute() {
        System.out.println("Elev1Up Execute");
    ...
    protected boolean isFinished() {
        return false; //Robot.elevator1.isTopSwitchSet();
    }
