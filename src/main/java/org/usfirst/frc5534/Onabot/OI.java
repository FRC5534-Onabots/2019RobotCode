...
public class OI {
    ...
    public OI() {
        ...
        operator2 = new XboxController(RobotMap.kOperatorControllerPort);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        driver.aButton.whenActive(new ElevPlatformDeployCmdGrp());
        driver.bButton.whenActive(new ElevPlatformRetractCmdGrp());
